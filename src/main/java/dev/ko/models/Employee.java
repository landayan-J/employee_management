...
public class Employee extends FXModel {
   ...
   public static class DEPARTEMENT_TABLECELL extends TableCell<Department, Employee>{
    @Override
    ...
    public Employee(String emp_id){
        this(emp_id, null, null, null, null, null, null,null);
    }

    public Employee(String emp_id, String name, Job job,Employee managaer, LocalDate hire_date, Long salary, Long commision,
    ...
    public FXModel clone() {
        Employee employee = new Employee(getEmpID(), getName(), getJob(), getManager(), getHireDate(), getSalary(), getCommission(), getDepartment());
        if (getManager() != null)
